...
class Suggestion(models.Model):
    title = models.CharField(max_length=1024)
    details = MarkupField(help_text="Describe what the talk you are suggesting is about")
    talk_type = models.ForeignKey(Talk_Type)
    author = models.ForeignKey(settings.AUTH_USER_MODEL, related_name="suggestions", default='')
